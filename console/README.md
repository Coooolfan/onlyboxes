...
- `CONSOLE_PROXY_ROUTE_KEY_LENGTH`: newly generated preview route key length (default `26`, range `8..26`); values below `16` are intended only for trusted local or low-risk deployments
