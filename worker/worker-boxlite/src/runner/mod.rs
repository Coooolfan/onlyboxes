...
pub(crate) const TERMINAL_LEASE_RENEW_CAPABILITY_NAME: &str = "terminalleaserenew";
pub(crate) const TERMINAL_LEASE_RENEW_CAPABILITY_DECLARED: &str = "terminalLeaseRenew";
