...
These management APIs accept Dashboard cookie, Console API key, or Dashboard JIT authentication. Routes are account-scoped and stored in memory. See [Public Preview Proxy](/en/docs/reverse-proxy) for the full deployment guide.
