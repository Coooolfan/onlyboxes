...
These management APIs accept Dashboard cookie, Console API key, or Dashboard JIT authentication. Routes are account-scoped and persisted in SQLite. See [Public Preview Proxy](/en/docs/reverse-proxy) for the full deployment guide.
