...
See the [annotated configuration template](https://github.com/Coooolfan/onlyboxes/blob/main/worker/worker-docker/config.example.toml) for all available keys.
