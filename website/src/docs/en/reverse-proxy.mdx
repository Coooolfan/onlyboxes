...
- Routes are stored in Console memory; Console restart invalidates all routes.
- Access logs may contain route keys — treat them as credential logs and limit retention and read access.
