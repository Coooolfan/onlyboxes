...
<template>
  <section
    class="grid grid-cols-3 gap-5 max-[960px]:grid-cols-2 max-[620px]:grid-cols-1 max-[620px]:gap-4"
  >
    <article
    ...
    >
      <p class="m-0 text-sm text-secondary font-medium">Online Workers</p>
      <p
