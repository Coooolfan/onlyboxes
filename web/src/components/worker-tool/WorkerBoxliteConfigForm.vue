...
<template>
  <div class="grid gap-4">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <label class="grid gap-1.5">
        <span class="text-sm text-secondary">WORKER_BOXLITE_HOME</span>
        <span class="text-xs text-secondary">Optional home directory for local Boxlite state.</span>
        <input
          v-model.trim="props.config.boxliteHome"
          type="text"
          class="ui-input rounded-md border px-3 py-2 text-sm"
      ...
      <label class="grid gap-1.5">
        ...
        <input
          ...
          type="text"
          class="ui-input rounded-md border px-3 py-2 text-sm"
          placeholder="./onlyboxes-worker-boxlite"
        />
      </label>
    </div>

    <details
      data-testid="boxlite-advanced-section"
    ...
    >
      ...
      <div class="grid grid-cols-1 gap-4 border-t border-stroke p-3 md:grid-cols-2">
        ...
        <label class="grid gap-1.5">
          <span class="text-sm text-secondary">WORKER_PYTHON_EXEC_BOXLITE_IMAGE</span>
          <span class="text-xs text-secondary"
            >Boxlite image used for one-shot pythonExec workloads.</span
          >
          <input
            v-model.trim="props.config.pythonExecBoxliteImage"
            type="text"
            class="ui-input rounded-md border px-3 py-2 text-sm"
          />
        </label>
        ...
        <label class="grid gap-1.5">
          <span class="text-sm text-secondary">WORKER_TERMINAL_EXEC_BOXLITE_IMAGE</span>
          <span class="text-xs text-secondary"
            >Boxlite image used for terminalExec and terminalResource sessions.</span
          >
          <input
            v-model.trim="props.config.terminalExecBoxliteImage"
            type="text"
            class="ui-input rounded-md border px-3 py-2 text-sm"
          />
        </label>
        ...
        <label class="grid gap-1.5">
          ...
          <span class="text-xs text-secondary">Python VM memory limit in MiB.</span>
          <input
        ...
        <label class="grid gap-1.5">
          ...
          <span class="text-xs text-secondary">Terminal VM memory limit in MiB.</span>
          <input
        ...
        <label class="grid gap-1.5">
          ...
          <span class="text-xs text-secondary">CPU count allocated to pythonExec boxes.</span>
          <input
        ...
        <label class="grid gap-1.5">
          ...
          <span class="text-xs text-secondary">CPU count allocated to terminal boxes.</span>
          <input
        ...
        <label class="grid gap-1.5">
          ...
          <span class="text-xs text-secondary">Maximum process count inside pythonExec boxes.</span>
          <input
        ...
        <label class="grid gap-1.5">
          ...
          <span class="text-xs text-secondary">Maximum process count inside terminal boxes.</span>
          <input
        ...
        <label class="grid gap-1.5 md:col-span-2">
          ...
          <span class="text-xs text-secondary">
            Maximum export payload size in bytes. Use 0 for unlimited.
          </span>
          <input
